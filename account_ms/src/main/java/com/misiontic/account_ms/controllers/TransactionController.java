...
public class TransactionController {
    ...
    Transaction newTransaction(@RequestBody Transaction transaction){
        ...
        if(accountOrigin == null) {
            throw new AccountNotFoundException("No se encontró la cuenta origen con el username: "
                    + transaction.getUsernameOrigin());
        }
        if(accountDestiny == null){
            throw new AccountNotFoundException("No se encontró la cuenta destino con el username: "
